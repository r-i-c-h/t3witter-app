...
export default function ErrorBox({
  errorTitle = `Error`,
  errorText = `We're sorry, an error has occured. Please try again, or contact us if the issue continues.`
}: ErrorBoxProps) {

  return (
    <div className="flex flex-col ml-4">
      <div className="m-4 flex max-w-md bg-red-200">
        <div className="w-16 bg-red-500">
          <div className="p-4">
            <svg className="h-8 w-8 fill-current text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <div className="w-auto items-center p-4 text-black opacity-75">
          <span className="pb-4 text-lg font-bold"> {errorTitle} </span>
